...
git checkout master
git pull
git checkout 46acdd0ebdbbd7a5ca50b76e7af19997d8f09f1d
#+end_src

#+RESULTS:
: Ваша ветка обновлена в соответствии с «origin/master».
: Обновление c230b96..46acdd0
: Fast-forward
:  R/arma.load.R | 12 +++++++++---
...
row_names <- list(
  deteremine_coefficients="Determine coefficients",
...
|----------------------------------+------+-------+--------+--------+--------|
| Determine coefficients           | 0.02 |  0.26 |   0.18 |   0.01 |   1.19 |
| Validate model                   | 0.09 | 19.19 |        |   0.08 |        |
| Generate wavy surface            | 1.29 | 10.12 | 351.67 | 769.42 |  25.09 |
