...
волн, является модель Лонге---Хиггинса (ЛХ)\nbsp{}cite:longuet1957statistical.
...
образуется так называемый /интервал разгона/ (см. рис.\nbsp{}[[fig:ramp-up-interval]])\nbsp{}---
...
независимо,\nbsp{}--- однако, в начале каждой из частей также присутствует интервал
разгона. Для его исключения используется метод /сшивания/, часто применяемый в
обработке цифровых сигналов\nbsp{}cite:oppenheim1989discrete,svoboda2011efficient,pavel2013algorithms. Суть метода
...
создан и отлажен прототип в программной среде Mathematica\nbsp{}cite:mathematica10, а
...
а также отсутствием трансцендентных функций в реализации алгоритма\nbsp{}cite:degtyarev2011effi. Во-вторых, для генерации одной реализации взволнованной
морского поверхности одной многопроцессорной машины достаточно для эффективного
и быстрого решения задачи (см. рис.\nbsp{}[[fig:autoreg-performance]]). По результатам
