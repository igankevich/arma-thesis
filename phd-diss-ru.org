...
тестирования программа была реализована на OpenMP и для тестирования алгоритма
распределения нагрузки переписана с использованием POSIX потоков.
Производительность двух реализаций сравнивалась на платформе, конфигурация
которой приведена в таблице [[tab:multicore-specs]].
